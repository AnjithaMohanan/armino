<template>
    <!-- Weather Card Component Markup -->
    <div class="bg-blue-100 p-7 text-blue-400 rounded-3xl col-span-3 md:row-span-2 w-full">
        <div v-if="typeof weather.main !== 'undefined'">

            <!-- Today and Arrow button -->
            <div class="flex items-center justify-center mb-4 text-blue-400">
            ...
            <div class="text-blue-300 text-5xl flex items-center justify-center">
                <div class="text-5xl ml-2">
                    {{ getWeatherSymbol(weather.weather[0].icon) }}
                </div>
                <div class="text-blue-400 text-8xl font-medium p-5">
...
<style>
/* Styles for Weather Card Component */
</style>
